...
@interface SalesViewController ()<NSURLConnectionDataDelegate,UITableViewDataSource,UITableViewDelegate>
...
-(void)requestData
{
    NSString *strUrl = @"http://10.0.8.10/app/qfts/iappfree/api/reduce.php?page=1&number=20";
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.currentPriceLabel.text = [NSString stringWithFormat:@"现价:￥%@",model.currentPrice];
    ...
    [cell.UIImageNameLabel setImageWithURL:[NSURL URLWithString:model.iconUrl] placeholderImage:[UIImage imageNamed:@"cate_list_bg1"]];
