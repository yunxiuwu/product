...
@interface HotViewController ()<NSURLConnectionDataDelegate,UITableViewDataSource,UITableViewDelegate>
...
-(void)requestData
{
    NSString *strUrl = @"http://10.0.8.10/app/qfts/iappfree/api/hot.php?page=1&number=20";
